...
import net.metic.androidmvp.`interface`.MainPresenter
import net.metic.androidmvp.`interface`.MainView
import net.metic.androidmvp.model.MainPresenterImp
...
class MainActivity : AppCompatActivity(), MainView {
    ...
    override fun showData(data: String) {
        ...
        AlertDialog.Builder(this)
            .setTitle("Data")
            .setMessage(data)
            .setPositiveButton("Close", DialogInterface.OnClickListener { dialogInterface, _ ->
